...
import com.example.zhang.na3.R;
import com.example.zhang.util.*;
...
public class BaseUI extends Activity{
    ...
    public void doEditText () {
        Intent intent = new Intent();
        intent.setAction(Primer.intent.action.EDITTEXT);
        this.startActivity(intent);
    }
    ...
    public void doEditBlog () {
        Intent intent = new Intent();
        intent.setAction(Primer.intent.action.EDITBLOG);
        this.startActivity(intent);
    }
